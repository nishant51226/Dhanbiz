import { ensurePracticeAgentBlock, ensureHmrcRefsFromStep1, showHmrcAgentCodes, type CustomerOnboardingData } from "./customerOnboarding";
import { getHmrcLogoDataUrl } from "./onboarding-template-image-src";
import { HMRC_LOGO_IMG_URL } from "./pdf-constants";
...
function hmrcLogoAbsoluteSrc(opts?: Hmrc648HtmlRenderOptions): string {
  ...
  const embedded = getHmrcLogoDataUrl();
